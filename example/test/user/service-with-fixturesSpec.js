...
describe('User - UserService - ', function () {
    ...
    beforeEach(function (done) {
        var realSequelizeInstance = DatabaseInstance.getCurrentInstance();

        sandbox.stub(DatabaseInstance, 'getCurrentInstance', function () {
            return new Sequelize('test-database', null, null, {
                'host': 'localhost',
                'dialect': 'sqlite',
                'storage': ':memory:',
                'define': {
        ...
        var sequelizeInstance = DatabaseInstance.getCurrentInstance();
